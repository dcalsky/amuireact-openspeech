...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpenspeechRecorder = __webpack_require__(1);
	OpenspeechRecorder.Volume = __webpack_require__(5);
	OpenspeechRecorder.Controller = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpenspeechRecorder = _react2.default.createClass({
	  ...
	  propTypes: {
	    ...
	    enable: _react2.default.PropTypes.bool, // component state of running
	    appid: _react2.default.PropTypes.string.isRequired, // your private app id
	    timestamp: _react2.default.PropTypes.string, // As same as the time stamp of signature
	    expires: _react2.default.PropTypes.number, // As same as the expires of signature
	  ...
	  _getControllerElement: function _getControllerElement() {},
	...
	var Volume = function (_Component) {
	  ...
	  _createClass(Volume, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'am-openspeech-volume' },
	        _react2.default.createElement('span', { className: 'am-openspeech-volume _volume-0', ref: 'volume0_0' }),
	        _react2.default.createElement('span', { className: 'am-openspeech-volume _volume-1', ref: 'volume1' }),
	        _react2.default.createElement('span', { className: 'am-openspeech-volume _volume-0', ref: 'volume0_1' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&sourceMap&importLoaders=1&localIdentName=[local]___[hash:base64:5]!./volume.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&sourceMap&importLoaders=1&localIdentName=[local]___[hash:base64:5]!./volume.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".am-openspeech-volume___qMpXC {\n  width: 24px;\n  margin: 0 6px;\n}", "", {"version":3,"sources":["/./src/style/volume.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,cAAc;CACf","file":"volume.css","sourcesContent":[".am-openspeech-volume {\n  width: 24px;\n  margin: 0 6px;\n}"],"sourceRoot":"webpack://"}]);
	
	// exports
	exports.locals = {
		"am-openspeech-volume": "am-openspeech-volume___qMpXC"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Controller.protoTypes = {
	  volume: _react2.default.PropTypes.number.isRequired // volume of wav player, 0 ~ 100
	};
